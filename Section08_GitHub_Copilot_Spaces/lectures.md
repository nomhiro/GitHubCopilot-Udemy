...
## レクチャー1: ナレッジベースとCopilot Spaces
**時間目安: 12分**

### 学習目標
- ナレッジベースの概念と目的を理解する
- Copilot SpacesとナレッジベースのEnterprise機能の関係を把握する
- 組織固有ドキュメント活用のメリットを理解する

### ナレッジベースとは

ナレッジベースは、組織固有の情報やドキュメントをCopilotに提供し、**よりコンテキストに関連した応答**を生成する仕組みです。GitHub Copilot Enterprise限定の機能であり、組織のプライベートコードベースやドキュメントを基に、パーソナライズされた提案を得ることができます。
...
Copilot Spacesは、関連コンテンツを整理・集中化し、Copilotの応答をグラウンディング（根拠づけ）する仕組みです。ナレッジベースの概念を発展させ、より柔軟なコンテキスト管理を提供します。
...
組織所有のスペースでは、GitHubの組み込み権限モデルを使用して、チームメンバー間でナレッジを共有できます。
...
ナレッジベース/Copilot Spacesに追加できるコンテキストソースは以下の通りです。
...
Instructionsは、Copilotの専門分野、支援すべきタスク、避けるべきことをガイドするフリーテキスト記述です。

#### 設定例

| 項目 | 例 |
|------|-----|
| **専門分野** | 「このプロジェクトはReactとTypeScriptで構築されています」 |
| **支援タスク** | 「コードレビューと最適化の提案を行います」 |
| **制約事項** | 「非推奨のAPIは提案しないでください」 |

### 監査ログでの追跡

ナレッジベースの操作は監査ログで追跡されます。
...
- ナレッジベースはEnterprise限定の機能
- 組織固有のドキュメントやコードベースを基に応答を生成
- Copilot Spacesで関連コンテンツを整理・管理
- 新入社員のオンボーディングや社内標準確認に有効

---

## レクチャー2: GitHub Copilot Spacesとは（概要と利点）
**時間目安: 10分**
...
## レクチャー6: 【確認テスト】GitHub Copilot Spaces
**時間目安: 5分**
